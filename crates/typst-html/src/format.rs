...
///
/// #import "../../../docs/components/index.typ": info, insertion, scope
///
/// // TODO: Add a way to specify groups for scope entries
/// #show: docs-category.with(
///   title: "HTML",
///   description: "Documentation for Typst's HTML export target.",
///   category: "html",
///   scope: scope(format, "html"),
///   groups: (
///     (
///       name: "typed",
///       title: "Typed HTML",
///       items: {
///         dictionary(stdx.describe(html).scope)
///           .pairs()
///           .filter(((_, val)) => {
...
/// Typst exposes HTML-specific functionality in the global `html` module. See
